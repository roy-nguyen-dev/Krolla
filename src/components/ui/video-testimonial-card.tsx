...
export default function VideoTestimonialCard({ 
  ...
  return (
    <div className={cn(
      ...
      {/* Thumbnail */}
      <div className="relative aspect-video bg-gradient-to-br from-accent-yellow/20 to-accent-purple/20">
        {/* Placeholder for video thumbnail - using testimonial image design */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-24 h-24 rounded-full bg-white/10 flex items-center justify-center">
            <div className="w-16 h-16 rounded-full bg-accent-yellow/20 flex items-center justify-center">
              <div className="w-8 h-8 rounded-full bg-accent-yellow/40"></div>
            </div>
          </div>
        </div>
